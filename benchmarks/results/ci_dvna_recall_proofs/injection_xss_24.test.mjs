...
// Rule: injection.xss
// Source: C:\Users\Josh\Downloads\CyberSecurity\benchmarks\dvna\dvna\views\app\adminusers.ejs:42
// Unsanitized HTML insertion can lead to XSS.

import { test } from 'node:test';
import assert from 'node:assert';

test('injection_xss_24: HTML sink receives executable handler payload', () => {
