...
// Rule: injection.xss
// Source: C:\Users\Josh\Downloads\CyberSecurity\benchmarks\dvna\dvna\views\app\adminusers.ejs:41
// Unsanitized HTML insertion can lead to XSS.

import { test } from 'node:test';
import assert from 'node:assert';

test('injection_xss_23: HTML sink receives executable handler payload', () => {
