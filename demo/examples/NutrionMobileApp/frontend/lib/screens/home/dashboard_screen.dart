...
class DashboardHome extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    // Hide AppBar in desktop mode (sidebar layout handles navigation)
    final isDesktop = ResponsiveBreakpoints.of(context).largerThan(TABLET);
  ...
  Widget _buildDailyProgressCard(BuildContext context,
      AuthProvider authProvider, Map<String, dynamic> totals) {
    ...
    // Get user goals or use defaults
    ...
    final goalCarbs = _getUserGoal(authProvider.user?.carbohydratesG, 250.0);
