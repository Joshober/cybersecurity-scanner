...
/// A modal nutrition calculator that can be embedded in ProfileScreen
/// Pre-fills with user profile data if available
class NutritionCalculatorModal extends StatefulWidget {
  final bool prefillFromProfile;
  
  const NutritionCalculatorModal({
    super.key,
    this.prefillFromProfile = true,
  });

  @override
  State<NutritionCalculatorModal> createState() => _NutritionCalculatorModalState();
}

class _NutritionCalculatorModalState extends State<NutritionCalculatorModal> {
